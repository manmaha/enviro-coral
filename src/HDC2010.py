...
class HDC2080:
        ...
        def __init__(self, twi=1, address=HDC2000_ADDRESS ):
                ...
                a1 = fcntl.ioctl(HDC2000_fr, I2C_SLAVE, address)
                a2 = fcntl.ioctl(HDC2000_fw, I2C_SLAVE, address)
                if (a1 <0 or a2 < 0):
                    exit() #abort
                time.sleep(0.1) 
...
if __name__ == '__main__':
  ...
  print ("temperature : {0:3.1f}, humidity : {1:3.1f}".format(hdc.readTemperature(), hdc.readHumidity()))
